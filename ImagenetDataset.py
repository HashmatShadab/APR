...
def find_classes(directory: str) -> Tuple[List[str], Dict[str, int]]:
    ...
    class_to_idx = {cls_name: class_label[cls_name] for i, cls_name in enumerate(classes)}
...
if __name__ =="__main__":
    image_transforms = transforms.Compose([
        ...
        transforms.Normalize(mean=[0.485, 0.456, 0.406],
                             std=[0.229, 0.224, 0.225])])
    dataset = ImageFolder(root="/home/hashmat.malik/PycharmProjects/Thesis/nobox-attacks/adv_images/test", transform=image_transforms)
